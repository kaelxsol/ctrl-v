// Content script for Beta Launch
// Injected into axiom.trade pages

(function() {
  'use strict';

  console.log('[Beta Launch] Content script loaded');
  ...
  function injectPanel() {
    ...
    console.log('[Beta Launch] Injecting panel...');
    ...
    console.log('[Beta Launch] CSS injected:', link.href);
    ...
    script.onload = () => {
      console.log('[Beta Launch] Panel JS loaded successfully');
      // Don't remove the script - we need to read data attributes from it
    };
    script.onerror = (e) => {
      console.error('[Beta Launch] Panel JS failed to load:', e);
    };
    document.head.appendChild(script);

    console.log('[Beta Launch] Panel injection initiated');
  }
  ...
  function handleCloneClick(tokenData) {
    console.log('[Beta Launch] Clone clicked:', tokenData);
  ...
  function extractTokenData() {
    ...
    try {
      ...
      console.warn('[Beta Launch] DOM extraction error:', err);
    }
   ...
   */
  function init() {
    console.log('[Beta Launch] Initializing...');
