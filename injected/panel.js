    ...
    return `
      <div class="flex flex-col gap-[12px]">
        ...
        <div class="flex flex-col items-center gap-[4px] pt-[8px] border-t border-white/10 mt-[4px]">
          <span class="text-[9px] text-white/40">Created by <a href="https://twitter.com/ctrlvlaunch" target="_blank" rel="noopener" class="text-white/60 hover:text-green-400 transition-colors">@ctrlvlaunch</a></span>
        </div>
      </div>
    `;
  }
